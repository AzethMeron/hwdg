...
{
	/**
	* Static class containing operations (algorithms) to be performed on graphs.
	* This is static class, so you can't create instances (objects) of it, and all methods are static member function.
	*/
	class Operations
	{
		public:
		...
		public:
			...
			* \f$O(edges)\f$
			*/
			static Graph Union(const Graph& a, const Graph& b); // linear
			...
			* \f$O(edges)\f$
			*/
			static Graph Union(const Graph& a, const Graph& b, float balancer); // linear
			...
			* \f$O(edges)\f$
			*/
			static void MergeUnion(Graph& a, const Graph& b); // linear
			...
			* \f$O(edges)\f$
			*/
			static void MergeUnion(Graph& a, const Graph& b, float balancer); // linear
			...
			* \f$O(edges)\f$
			*/
			static Graph Intersection(const Graph& a, const Graph& b, float balancer); // linear
			...
			* \f$O(edges)\f$
			*/
			static Graph InverseIntersection(const Graph& a, const Graph& b);
			...
			* \f$O(edges)\f$
			*/
			static Graph Difference(const Graph& a, const Graph& b); // linear
			...
			* \f$O(edges)\f$
			*/
			static double ContainmentSimilarity(const Graph& a, const Graph& b); // linear
			...
			* \f$O(1)\f$
			*/
			static double SizeSimilarity(const Graph& a, const Graph& b); // constant
			...
			* \f$O(edges)\f$
			*/
			static double ValueSimilarity(const Graph& a, const Graph& b); // linear
			...
			* \f$O(edges)\f$
			*/
			static double NormalizedValueSimilarity(const Graph& a, const Graph& b); // linear
			...
			* \f$O(edges)\f$
			*/
			static void BreadthFirstSearch(const Graph& graph, const Node& starting_node, std::function<void(const Edge& edge, const std::unordered_set<Node, Node::HashFunction>& visited)> func);
			...
			* \f$O(edges)\f$
			*/
			static void BreadthFirstSearch(const Graph& graph, const Node& starting_node,
			...
			* \f$O(edges)\f$
			*/
			static void DepthFirstSearch(const Graph& graph, const Node& starting_node, std::function<void(const Edge& edge, const std::unordered_set<Node, Node::HashFunction>& visited)> func);
			...
			* \f$O(edges)\f$
			*/
			static void DepthFirstSearch(const Graph& graph, const Node& starting_node,
				std::function<void(const Edge& edge, const std::unordered_set<Node, Node::HashFunction>& visited)> func,
				std::function<void(const NodeInGraph& node, std::vector<Edge>& to_be_traversed_first, const std::unordered_set<Node, Node::HashFunction>& visited)> priority);
	};
}
