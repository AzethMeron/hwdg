...
{
	/**
	* Static class containing tools for serialization and debugging utilities.
	* This is static class, so you can't create instances (objects) of it, and all methods are static member function.
	*/
	class Tools
	{
		private:
			static constexpr char HEADER_BIN[] = "HDWGBIN";
			static constexpr char HEADER_BIN_REV[] = "NIBGWDH";
			static constexpr char HEADER_SAVE[] = "HDWGSAV";
			static constexpr char HEADER_SAVE_REV[] = "VASGWDH";
		...
		public:
			...
			*/
			...
			static void SaveBin(const TYPE& obj, const std::string& filename)
			{
				std::ofstream file;
			...
			*/
			template<typename TYPE>
			static TYPE LoadBin(const std::string& filename)
			{
				std::ifstream file;
			...
			*/
			template<typename TYPE>
			static void SaveTxt(const TYPE& obj, const std::string& filename)
			{
			...
			*/
			template<typename TYPE>
			static TYPE LoadTxt(const std::string& filename)
			{
